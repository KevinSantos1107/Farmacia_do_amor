...
function addStarMapTabToAdmin() {
    // ✅ Tab de star-map já está no HTML estático - apenas inicializar listeners
    ...
    const calcBtn = document.getElementById('calculatePreviewBtn');
    if (calcBtn) calcBtn.addEventListener('click', calculateConstellationPreview);
    ...
    try { loadStarMapConfig(); } catch (e) {}

    console.log('✅ Tab Mapa das Estrelas ativada (HTML existente ou criada dinamicamente)');
}
