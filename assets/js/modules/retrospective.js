...
class Retrospective {
    ...
    async openModal() {
        ...
        document.documentElement.classList.add('retro-scroll-lock');
        document.body.classList.add('retro-scroll-lock');
    ...
    closeModal() {
        ...
        document.documentElement.classList.remove('retro-scroll-lock');
        document.body.classList.remove('retro-scroll-lock');
