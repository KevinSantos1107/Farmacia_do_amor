...
class Retrospective {
    ...
    async openModal() {
        ...
        const firstAnniversary = new Date('2026-10-27T00:00:00');
        const now = new Date();
        ...
        if (RETRO_DEV_MODE || devByURL || devByStorage) {
            console.info('🔓 Retrospectiva: modo teste ATIVO — bloqueio de data ignorado.');
        }
