                ...
                <div class="admin-album-card-overlay">
                    ...
                    <div class="admin-album-card-actions">
                        <div class="card-action-row">
                            ...
                            <button class="admin-album-action-btn photos" onclick="addPhotosToAlbumFromGrid('${id}', '${title}')">
                                <i class="fas fa-plus"></i> Fotos
                            </button>
                        </div>
                        <button class="admin-album-action-btn delete" onclick="deleteAlbumFromGrid('${id}', '${title}')">
                            <i class="fas fa-trash"></i> Excluir
                        </button>
                    </div>
                </div>
