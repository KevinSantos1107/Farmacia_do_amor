...
function renderAlbums(albums) {
    ...
    if (albums.length === 0) {
        container.innerHTML = `
            <div style="grid-column: 1 / -1; padding: 3rem; text-align: center; color: var(--theme-text-secondary);">
                ...
                <p style="font-size: 0.9rem; margin-top: 0.5rem;">Use o painel admin para criar seu primeiro álbum!</p>
            </div>
        `;
        return;
    }
    ...
    console.log(`✅ ${albums.length} álbuns renderizados na tela`);
}
